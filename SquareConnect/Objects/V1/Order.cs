...
namespace SquareConnect.Objects.V1
{
    ...
    public class Order
    {
        ...
        /// <summary>
        /// The order's current state, such as <see cref="OrderState.Open"/> or <see cref="OrderState.Completed"/>.
        /// </summary>
        ...
        /// <summary>
        /// A note provided by the merchant when the order's state was set to <see cref="OrderState.Completed"/>, if any.
        /// </summary>
        [JsonProperty("completed_note")]
        public string CompletedNote;

        /// <summary>
        /// A note provided by the merchant when the order's state was set to <see cref="OrderState.Refunded"/>, if any.
        /// </summary>
        [JsonProperty("refunded_note")]
        public string RefundedNote;

        /// <summary>
        /// A note provided by the merchant when the order's state was set to <see cref="OrderState.Canceled"/>, if any.
        /// </summary>
