...
namespace SquareConnect.Objects.V1
{
    ...
    public class ItemVariation
    {
        ...
        /// <summary>
        /// If the inventory quantity for the variation is less than or equal to this value and <see cref="InventoryAlertType"/> is <see cref="V1.InventoryAlertType.LowQuantity"/>, the variation displays an alert in the merchant dashboard.
        /// </summary>
